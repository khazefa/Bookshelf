# Bookshelf 1.0
Created using Java, Maven with Netbeans 8.2 IDE

## Installation
Please install and use JDk 8 or newer to ensure that this program run smoothly.
...
## How to Run
Run Bookshelf with the file-input.text as command source:
```
java -jar target/Bookshelf-1.0.jar file-input.txt
```
Or you could type command by yourself
```
java -jar target/Bookshelf-1.0.jar
```
